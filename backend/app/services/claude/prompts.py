...
AGENT_SYSTEM = dedent("""\
    ...
    ОТЧЁТ В FINISH (обязательно для задач new_site / figma_to_site / new_bot / установка CMS):
    В поле summary вызова finish ВСЕГДА включи блок доступов в конце:
    ---
    🌐 Сайт: https://example.com
    🔧 Админка: https://example.com/wp-admin (или /admin, /dashboard — по факту)
    👤 Логин: admin
    🔑 Пароль: <использованный пароль>
    📧 Email: <email администратора>
    ---
    Если устанавливал CMS — укажи реальные данные, которые использовал при установке.
    Если делал фичу или правку (не установку) — блок доступов не нужен.""")
